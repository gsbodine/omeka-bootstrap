        ...
        <div class="row">
            ...
            <div id="footer-text" class="row">
                <div class="span6 muted">
                    <div class="row">
                        <div class="span2 text-center"><a href="http://bloomu.edu"><img src="<?php echo img('BU.png'); ?>" class="footer-logo" /></a></div>
                        <div class="span2 text-center"><a href="http://berry.edu/oakhill"><img src="<?php echo img('OakHill.png'); ?>" class="footer-logo" /></a></div>
                        <div class="span2 text-center" style="text-align: center;"><a href="http://berry.edu"><img src="<?php echo img('BC.png'); ?>" class="footer-logo" /></a></div>
                    </div>
